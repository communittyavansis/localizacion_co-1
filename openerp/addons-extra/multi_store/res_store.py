...
class res_store(models.Model):
    ...
    street = fields.Char('Dirección', size=128,)
    city = fields.Char('Ciudad', size=32,)
    phone = fields.Char('Teléfono', size=32,)
    info = fields.Char('Información adicional', size=128,)
    ...
    warehouse_ids = fields.One2many(
        'stock.warehouse', 'store_id', 'Warehouse')
