...
class stock_quant(osv.osv):
    ...
    def _quant_split(self, cr, uid, quant, qty, context=None):
        ...
        #Recupera el costo promedio actual
        cost = quant.product_id.standard_price or 0.00
        ...
        self.write(cr, SUPERUSER_ID, quant.id, {'cost':cost}, context=context)
        self.write(cr, SUPERUSER_ID, new_quant, {'cost':cost}, context=context)
...
class stock_move(osv.osv):
    ...
    def get_price_unit(self, cr, uid, move, context=None):
        ...
        return move.product_id.standard_price or move.price_unit
    ...
    def _quantity_normalize(self, cr, uid, ids, name, args, context=None):
        ...
        res = {}
        for m in self.browse(cr, uid, ids, context=context):
	    l = uom_obj._compute_qty_obj(cr, uid, m.product_uom, m.product_uom_qty, m.product_id.uom_id, round=False, context=context)
